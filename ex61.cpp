//This program creates uses a structure for loan, initialize it from the keyboard
//then, displays the struct
...
struct Loan{ //Loan is the structure tag
...
float payment(Loan l){
  ...
  l.rate/1200; //To convert % yearly rate to monthly fraction
